...
const EventDetailPage = async ({ params: { id }, searchParams }: SearchParamProps) => {
  ...
  return (
   <>
      <section className="flex justify-center bg-dotted-pattern bg-contain bg-primary-50 ">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <div className="flex gap-3">
                  ...
                  <p className="p-medium-16 px-5 py-2.5 text-grey-500 rounded-full bg-grey-500/10 ">
                    {event.category.name}
                  </p>
                </div>
                <p className="mt-2 sm:0 p-medium-18 ml-2">
                  by{" "}
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="p-regular-20 flex items-center gap-3">
                <Image
                  ...
                  width={32}
                />
                <p className="p-meidum-16 lg:p-regular-20">{event.location}</p>
              </div>
            CC</div>
